    ...
    <div class="telcel-container">        
        ...
        <div id="run" class="telcel-run telcel-section">
        	<div class="telcel-run-cont">
                ...
                <h3><strong>1a Carrera Sindicato Telcel Monterrey 6 de marzo</strong></h3>
                <div class="countdown-cont">
                	<h4 class="header3-blue">Monterrey</h4>
                    <ul class="countdown3">
                ...
                <div class="telcel-challenge">
                    <div class="telcel-challenge-item center-challenge">
                        ...
                        <div class="challenge-text">
                       	  <h4>Carrera <br />
                       	  <strong>Sindicato Telcel Monterrey</strong></h4>
                          	<p><strong>Fecha:</strong> Domingo 6 de marzo del 2016<br />
                            <strong>Lugar:</strong> Monterrey<br />
                            ...
                            <ul>
                              ...
                              <li><a href="../files/ENTREGAKITS.pdf" target="_blank">Entrega de Kits</a></li>
                              <li><a href="../files/convocatoriamonterrey2016.pdf" target="_blank">Ver convocatoria</a></li>
    ...
    <div class="telcel-container"> 
        <div id="sus" class="telcel-sus telcel-section">
        	<div class="telcel-sus-cont">
            	<h2 class="header">CARRERA MERIDA 7 FEBRERO 2016</h2>
            	<div class="links-otros">
            	  <div class="no-capacity">
            	    <p>La carrera ha cubierto su cupo máximo  Te esperamos para la proxima carrera</p>
							</div>
            	</div>
        ...
        <div id="fut" class="telcel-fut telcel-section">
        	<div class="telcel-fut-cont">
                ...
                <div class="telcel-fut-text">
                    ...
                    <p>Para más información <a href="mailto:"></a>, <a href="mailto:"></a> o con la persona de contacto de tu localidad (RRHH).</p>
